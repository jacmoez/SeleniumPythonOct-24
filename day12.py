...
class TestRenovationTest:
    ...
    def test_logout(self):
        ...
        self.driver.find_element(By.XPATH, "/html/body/div/div/div[3]/div").click()
    ...
    def test_step_two(self):
        ...
        time.sleep(1)
        #Property type *
        self.driver.find_element(By.XPATH, "/html/body/div/div/main/div/form[2]/div/div[2]/div/div[1]/div/div[1]/fieldset/div/button[4]").click()
        time.sleep(1)

        #Property Status *

        property_status = self.driver.find_element(By.XPATH, "/html/body/div/div/main/div/form[2]/div/div[2]/div/div[1]/div/fieldset[2]/div/button[1]")
        ...
        time.sleep(2)
        #Your floor plans (Optional)
        img_path1 = os.path.abspath("/Users/user/Desktop/Screenshot 2024-11-20 at 19.35.02.png")
        img_path2 = os.path.abspath("/Users/user/Desktop/Screenshot 2024-11-20 at 19.35.02.png")

        img_path = f"{img_path1}\n{img_path2}"
        time.sleep(2)
        self.driver.find_element(By.NAME, "floorPlanImages").send_keys(img_path)

        #btn Next
        self.driver.find_element(By.XPATH, "/html/body/div/div/main/div/div/div[2]/div/div[2]/button").click()
        time.sleep(2)

        img = self.driver.find_element(By.XPATH, "/html/body/div/div/main/div/form[3]/div/div[2]/div/div[1]/div/ul/li[36]/div[1]/div/img")
    ...
    def test_search(self):
        ...
        text = self.driver.find_element(By.CLASS_NAME, "header-h6-bold").text

        self.driver.find_element(By.XPATH, "/html/body/div/div/main/section[2]/section/div/div[1]/div/div/div[1]").click()

        time.sleep(2)
        text = self.driver.find_element(By.CSS_SELECTOR, ".header-h3-regular.text-white").text
        print("Success", text)
